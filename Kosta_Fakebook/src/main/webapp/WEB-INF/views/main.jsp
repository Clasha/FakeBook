...
<script type="text/javascript">
	...
	$(document).on('click', '.bLike', function() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				obj.html("<img src='resources/img/like.png' width='15' height='15' style='vertical-align: middle;'> 좋아요 "+bLikeCount);
			},
			error : function() {
	...
	$(document).on('click', '.bLikeCancel', function() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				obj.attr('bLikeCount', bLikeCount);				
				obj.html("<img src='resources/img/notlike.png' width='15' height='15' style='vertical-align: middle;'> 좋아요 "+bLikeCount);
			},
			error : function() {
	...
	$(document).on('input', '#editTextarea', function() {
		//alert('input');
		var board_num = $(this).attr('board_num');
		var str = $('#editTextarea[board_num="'+board_num+'"]').html();
		var pattern = /#[a-zA-Z0-9가-힣_]+\s/gim;
		var txt = str.match(pattern);
